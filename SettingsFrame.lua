...
function HMPTab_OnClick(self)
	...
	if tabId == 1 then
		...
		HMPJunkerSoulboundText:Hide()
		HMPJunkerSoulboundCB:Hide()
	...
	elseif tabId == 3 then
		...
		HMPJunkerSoulboundText:Show()
		HMPJunkerSoulboundCB:Show()
...
function HelpMePlayLoadSettings()
	if HMPOptionsFrame:IsVisible() then
		...
		if UnitAffectingCombat("player") == false then
			...
			HMPJunkerSoulboundText:SetText(L_GLOBALSTRINGS["Soulbound"])
			...
			HMPJunkerSoulboundCB:SetChecked(HelpMePlayOptionsDB.Junker.isSoulboundEnabled)
			...
			HMPDisableAllCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Disable All Check Button"])
			end)
			...
			HMPDialogCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Dialog Check Button"])
			end)
			...
			HMPEmotesCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Emotes Check Button"])
			end)
			...
			HMPGarrTblCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Garrison Tables Check Button"])
			end)
			...
			HMPMerchantsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Merchants Check Button"])
			end)
			...
			HMPTrainersV2CB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Trainers Check Button"])
			end)
			...
			HMPSpeechCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Speech Check Button"])
			end)
			...
			HMPWarModeCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["War Mode Check Button"])
			end)
			...
			HMPQuestsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Quests Check Button"])
			end)
			...
			HMPToFCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Threads of Fate Check Button"])
			end)
			...
			HMPNotesCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Notes Check Button"])
			end)
			...
			HMPTalentsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Talents Check Button"])
			end)
			...
			HMPCinematicsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Cinematics Check Button"])
			end)
			...
			HMPQueuesCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Queues Check Button"])
			end)
			...
			HMPVehiclesCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Vehicles Check Button"])
			end)
			...
			HMPWaypointsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Waypoints Check Button"])
			end)
			...
			HMPWeightsCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Weights Check Button"])
			end)
			...
			HMPPartyPlayCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Party Play Check Button"])
			end)
			...
			HMPPartyPlayAnnounceCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Party Play Announce Check Button"])
			end)
			...
			HMPPartyPlayAutoShareCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Party Play Auto Share Check Button"])
			end)
			...
			HMPMinimapIconCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Minimap Icon Check Button"])
			end)
			...
			HMPEnableJunkerCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Junker Check Button"])
			end)
			...
			HMPJunkerSafeModeCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Junker Safe Mode Check Button"])
			end)
			...
			-- Junker Soulbound Check Button
			HMPJunkerSoulboundCB:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Junker Soulbound Check Button"])
			end)
			HMPJunkerSoulboundCB:SetScript("OnLeave", function(self)
				addonTable.HideTooltip(self)
			end)
			HMPJunkerSoulboundCB:SetScript("OnClick", function(self)
				HelpMePlayOptionsDB["Junker"]["isSoulboundEnabled"] = self:GetChecked()
			end)
			...
			HMPQuestRewardDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Quest Rewards DropDown"])
			end)
			...
			HMPTorghastPowersDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Torghast Powers DropDown"])
			end)
			...
			HMPCovenantsDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Covenants DropDown"])
			end)
			...
			HMPBFAZoneSelDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["BFA Zone Selection DropDown"])
			end)
			...
			HMPSLZoneSelDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["SL Zone Selection DropDown"])
			end)
			...
			HMPJunkerRarityDropDown:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Junker: Rarity DropDown"])
			end)
				...
				StaticPopupDialogs["HELPMEPLAY_JUNKER_IMPORT"] = {
					...
					OnButton1 = function(self, data)
						if IsAddOnLoaded("AutoVendor") then
							...
							addonTable.Print(string.format(L_GLOBALSTRINGS["Colored Addon Name"] .. ": " .. L_GLOBALSTRINGS["Imported To Junker Text"], "AutoVendor"))
						elseif IsAddOnLoaded("Dejunk") then
							...
							addonTable.Print(string.format(L_GLOBALSTRINGS["Colored Addon Name"] .. ": " .. L_GLOBALSTRINGS["Imported To Junker Text"], "Dejunk"))
						else
							addonTable.Print(L_GLOBALSTRINGS["Colored Addon Name"] .. ": " .. L_GLOBALSTRINGS["No Auto Sell AddOn Enabled"])
						end
					end,
			...
			HMPOptionsFrameTab1:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Tab Description: Automations"])
			end)
			...
			HMPOptionsFrameTab2:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Tab Description: Systems"])
			end)
			...
			HMPOptionsFrameTab3:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Tab Description: General"])
			end)
			...
			HMPOptionsFrameTab4:SetScript("OnEnter", function(self)
				addonTable.ShowTooltip(self, L_GLOBALSTRINGS["Tab Description: Junker"])
			end)
