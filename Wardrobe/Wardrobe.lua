...
EventRegistry:RegisterCallback("CharacterFrame.Show", function()
    if not transmogrificationButton then
        ...
        transmogrificationButton:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Click to learn all unknown and appropriate appearances in your inventory.", 1, 1, 1, true)
            GameTooltip:Show()
        end)
        transmogrificationButton:SetScript("OnLeave", function()
            GameTooltip:Hide()
        end)
