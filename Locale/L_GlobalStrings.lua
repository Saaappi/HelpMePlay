...
if (isLocaleSupported) then
	...
	L_GLOBALSTRINGS["Junker Merchant Button"]													= "This button can be used to retrigger the selling process.\n\nThis button only appears when |cffFFFFFFSafe Mode|r is enabled."
