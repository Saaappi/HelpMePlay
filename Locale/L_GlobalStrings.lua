...
if (isLocaleSupported) then
	...
	L_GLOBALSTRINGS["Party Play Announce Check Button"]											= "If you don't want to broadcast when you've\naccepted a quest, then keep this unchecked."
	L_GLOBALSTRINGS["Party Play Auto Share Check Button"]										= "If you don't want to auto share quests,\nthen keep this unchecked."
