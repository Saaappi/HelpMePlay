...
if (isLocaleSupported) then
	...
	L_GLOBALSTRINGS["BFA Zone Selection DropDown"]												= "|cffFFFFFFBFA Zone Selection|r\nPick the FIRST zone to play through in BFA.\n\nYou may not need this feature."
	L_GLOBALSTRINGS["SL Zone Selection DropDown"]												= "|cffFFFFFFShadowlands Zone Selection|r\nPick the FIRST zone to play through in Shadowlands.\n\nYou may not need this feature."
