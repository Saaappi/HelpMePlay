...
if (isLocaleSupported) then
	...
	L_GLOBALSTRINGS["Quests.DropDowns.ChromieTime.Desc"]										= "Automates the expansion to select when speaking with Chromie.\n\n|cffFFD100Kraken Latte|r is an option that will select Legion first, then Warlords of Draenor. The route itself remains the same. If you follow Kraken's route to the T, then please select this option.\n\n|cffFFD100Default|r: Battle for Azeroth (Current Timeline)"
