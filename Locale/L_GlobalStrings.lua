...
if (isLocaleSupported) then
	...
	L_GLOBALSTRINGS["Quests.DropDowns.QuestRewards.Desc"]										= "Determines how quest rewards are selected. |cffFFD100Note|r: This automation is ignored for max-level players.\n\n|cffFFD100Item Level|r: Selects the item with the highest item level upgrade value. Weapon rewards aren't selected automatically; players will need to make their decision manually.\n\n|cffFFD100Sell Price|r: Selects the reward with the highest sell price.\n\nIf Junker is enabled, then the chosen reward is automatically added to its global list regardless of the option selected in the list."
	...
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.Option.Custom"] 								= "Custom"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.Option.Custom.Text"] 							= "Enter the icon name that you wish to have on quest NPC nameplates.\n\nThe icon name can be siphoned from Wowhead by clicking on the icon for a spell, achievement, etc."
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition"]									= "Position"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Desc"]								= "Where on the nameplate should the icon be shown?"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.Top"]						= "TOP"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.Bottom"]					= "BOTTOM"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.Left"]						= "LEFT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.Right"]						= "RIGHT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.TopLeft"]					= "TOPLEFT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.TopRight"]					= "TOPRIGHT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.BottomLeft"]				= "BOTTOMLEFT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.BottomRight"]				= "BOTTOMRIGHT"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.IconPosition.Option.Center"]					= "CENTER"
	L_GLOBALSTRINGS["Quests.DropDowns.QuestMobs.XOffset"]										= "X Offset"
	...
	L_GLOBALSTRINGS["DropDowns.Junker.Rarity.PreserveTransmog"]									= "|cff9D9D9DPreserve Transmog|r"
	...
	L_GLOBALSTRINGS["Text.Output.LearnedTalent"] 												= "Learned a new talent!"
	...
	L_GLOBALSTRINGS["PlayerTalents.Config.Name"] 												= "HelpMePlay"
	-- End: 	Player Talents
	--
