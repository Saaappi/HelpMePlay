...
if (isLocaleSupported) then
	...
	L_DIALOG["Wormhole: Revendreth, Court of the Venthyr"]									= "Revendreth, Court of the Venthyr"
	L_DIALOG["Wormhole: Ardenweald, Forest of the Night Fae"]								= "Ardenweald, Forest of the Night Fae"
