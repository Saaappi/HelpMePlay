...
local changesOptions = {
	...
	args = {
		...
		fixedText = {
			...
			coloredDash .. "Fixed an issue that caused the game to crash when the player added a gossip but didn't add support for confirmation associated with that gossip. (|cff009AE4(e.g. Asking a Stable Master to mend your battle pets.|r)",
			order = 31,
			type = "description",
			fontSize = "medium",
		},
