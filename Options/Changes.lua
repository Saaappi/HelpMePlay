...
local changesOptions = {
	...
	args = {
		...
		fixedText = {
			...
			coloredDash .. "Fixed an issue that caused the game to crash when the player interacted with an NPC that had logged gossip and unlogged confirmation. (|cff009AE4e.g. The game would crash when the player asked a Stable Master to mend their battle pets.|r)",
			order = 31,
			type = "description",
			fontSize = "medium",
		},
