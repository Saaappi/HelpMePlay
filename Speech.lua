...
local function AddGlowToActionBarButton(buttonId)
	ActionButton_ShowOverlayGlow(_G["OverrideActionBarButton"]..buttonId)
	C_Timer.After(3, function()
		ActionButton_HideOverlayGlow(_G["OverrideActionBarButton"]..buttonId)
	end)
end
