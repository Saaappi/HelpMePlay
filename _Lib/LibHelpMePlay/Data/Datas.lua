...
LHMP.Gossips = {
    ...
    [33072] = {{ID = 37858, CanConfirm = false, Conditions = {{"QUEST_ACTIVE", {13882}}}}},
    [34392] = {{ID = 36843, CanConfirm = false, Conditions = {{"QUEST_ACTIVE", {13885}}}}},
    -- Ashenvale
    [34289] = {
        {
            ID = 37319,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {13886}}, {"QUEST_OBJECTIVES_COMPLETE", {{13886, 1}}}}
        }
    },
    [34377] = {
        {
            ID = 37711,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {13935}}, {"QUEST_OBJECTIVES_COMPLETE", {{13935, 1}}}}
        }
    },
    [34618] = {
    ...
    [41071] = {
        {
            ID = 38774,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {25669}}, {"QUEST_OBJECTIVES_COMPLETE", {{25669, 1}}}}
        }
    },
    -- Southern Barrens
    ...
    [37570] = {
        {
            ID = 37335,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {24601}}, {"QUEST_OBJECTIVES_COMPLETE", {{24601, 1}}}}
        }
    },
    [37743] = {
        {
            ID = 38196,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {25057}}, {"QUEST_OBJECTIVES_COMPLETE", {{25057, 1}}}}
        }
    },
    [39155] = {
        {
            ID = 36883,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {25120}}, {"QUEST_OBJECTIVES_COMPLETE", {{25120, 1}}}}
        }
    },
    -- Desolace
    [35773] = {
        {
            ID = 38386,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {14256}}, {"QUEST_OBJECTIVES_COMPLETE", {{14256, 1}}}}
        },
    ...
    [35902] = {
        {
            ID = 37927,
            CanConfirm = false,
            Conditions = {{"QUEST_ACTIVE", {14284}}, {"QUEST_OBJECTIVES_COMPLETE", {{14284, 1}}}}
        }
    },
    ...
    [39723] = {
        {
            ...
            Conditions = {
                {"LEVEL_LOWER", 20},
                {"QUESTS_ACTIVE", {25399, 25458}},
                {"QUEST_OBJECTIVES_COMPLETE", {{25399, 1}, {25458, 1}}}
            }
        }
    },
    -- Westfall
    ...
    -- Western Plaguelands
    [46006] = {{ID = 39847, CanConfirm = false, Conditions = {{"LEVEL_LOWER", 20}, {"QUEST_ACTIVE", {27165}}}}},
    ...
    [3310] = {
        {
            ID = 30402,
            CanConfirm = false,
            Conditions = {{"LEVEL_LOWER", 30}, {"QUEST_ACTIVE", {31853}}, {"QUEST_OBJECTIVES_COMPLETE", {{31853, 1}}}}
        }
    },
    ...
    [59392] = {
        {
            ID = 39631,
            CanConfirm = false,
            Conditions = {{"LEVEL_LOWER", 30}, {"QUEST_ACTIVE", {30495}}, {"QUEST_OBJECTIVE_INCOMPLETE", {30495, 4}}}
        },
    ...
    [56592] = {
        {ID = 40154, CanConfirm = false, Conditions = {{"QUEST_ACTIVE", {29903}}}},
        [56591] = {
        ...
        [64207] = {{ID = 28426, CanConfirm = false, Conditions = {{"LEVEL_LOWER", 30}, {"QUEST_ACTIVE", {30485}}}}},
        ...
        [73306] = {
            {
                ID = 41556,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 33343", "QUEST_OBJECTIVE_INCOMPLETE = 33343,1"}
            }
        },
        -------------------------
        -- WARLORDS OF DRAENOR --
        ...
        [161666] = {
            {ID = 49525, CanConfirm = false, Conditions = {"QUEST_ACTIVE = 60168"}},
            {
                ID = 49523,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 60168", "QUEST_OBJECTIVE_INCOMPLETE = 60168,3"}
            }
        },
        ...
        [167215] = {
            {ID = 52668, CanConfirm = false, Conditions = {"QUEST_ACTIVE = 60162"}},
            {
                ID = 52666,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 60162", "QUEST_OBJECTIVE_INCOMPLETE = 60162,3"}
            }
        },
        [167184] = {
        ...
        [193364] = {
            {
                ID = 55584,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 68798", "QUEST_OBJECTIVE_INCOMPLETE = 68798,2"}
            }
        },
        ...
        [192795] = {
            {
                ID = 107399,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 72241", "QUEST_OBJECTIVE_INCOMPLETE = 72241,1"}
            }
        },
        ...
        [187466] = {{ID = 55307, CanConfirm = false, Conditions = {"QUEST_ACTIVE = 66048"}}},
        [187187] = {
            {
                ID = 54628,
                CanConfirm = false,
                Conditions = {"QUEST_ACTIVE = 66078", "QUEST_OBJECTIVE_INCOMPLETE = 66078,1"}
            }
        },
        [187189] = {
            {
        ...
        [186681] = {{ID = 55405, CanConfirm = false, Conditions = {"QUEST_ACTIVE = 65939"}}},
        [186933] = {{ID = 54627, CanConfirm = false, Conditions = {"QUEST_ACTIVE = 66044"}}},
        [217220] = {
