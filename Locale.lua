...
if (isLocaleSupported) then
	...
	-- Chat Filters
	L["Already on that quest."]													= "already on that quest."
	-- Strings																	
	...
	L["Quests Check Button"]													= "Automates accepting and completing quests, selecting quest\nrewards, and adds an icon to enemies required for quests.\n\n|cffCB453DNote|r: The icon should only appear when using Blizzard's\ndefault nameplates."
	...
	L["Bolvar requests your current report."]									= "Bolvar requests your current report."
	L["Let's go."]																= "Let's go."
	L["Let's go!"]																= "Let's go!"
	...
	L["It is not safe here."]													= "It is not safe here."
	...
	L["I need to restore these remnants."]										= "I need to restore these remnants."
	...
	L["We need you for Mechagon."]												= "We need you for Mechagon."
	L["MOTHER 1"]																= "Begin the activation sequence."
	L["Sapphronetta Flivvers 1"]												= "What problem?"
	L["Grizzek Fizzwrench 1"]													= "Your partner in life, love, and the lab says I should invite you to come to Mechagon."
	...
	L["Spiritwalker Ebonhorn 3"]												= "I'm investigating unusual magical activity in the area."
	L["Spiritwalker Ebonhorn 4"]												= "Let's go meet Magni."
	...
	L["Lady Jaina Proudmoore 5"]												= "Jaina, can you show us the area around the palace?"
	...
	L["Highlord Bolvar Fordragon 5"]											= "What's next?"
